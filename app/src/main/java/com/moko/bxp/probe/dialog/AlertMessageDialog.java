...
import com.moko.bxp.probe.databinding.DialogAlertProbeBinding;

public class AlertMessageDialog extends MokoBaseDialog<DialogAlertProbeBinding> {
    ...
    @Override
    protected DialogAlertProbeBinding getViewBind(LayoutInflater inflater, ViewGroup container) {
        return DialogAlertProbeBinding.inflate(inflater, container, false);
    }

...
import com.moko.bxp.probe.databinding.DialogLoadingMessageProbeBinding;
import com.moko.bxp.probe.view.ProgressDrawable;

public class LoadingMessageDialog extends MokoBaseDialog<DialogLoadingMessageProbeBinding> {
    ...
    @Override
    protected DialogLoadingMessageProbeBinding getViewBind(LayoutInflater inflater, ViewGroup container) {
        return DialogLoadingMessageProbeBinding.inflate(inflater, container, false);
    }

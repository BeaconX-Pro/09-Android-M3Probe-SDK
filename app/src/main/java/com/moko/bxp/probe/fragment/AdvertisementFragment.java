...
import com.moko.bxp.probe.databinding.FragmentAdvertisementProbeBinding;
import com.moko.bxp.probe.dialog.BottomDialog;

import java.util.ArrayList;
import java.util.Arrays;

public class AdvertisementFragment extends Fragment implements SeekBar.OnSeekBarChangeListener {
    private FragmentAdvertisementProbeBinding mBind;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mBind = FragmentAdvertisementProbeBinding.inflate(inflater, container, false);

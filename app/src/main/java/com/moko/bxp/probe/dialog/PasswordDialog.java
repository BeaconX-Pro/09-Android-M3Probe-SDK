...
import com.moko.bxp.probe.databinding.DialogPasswordProbeBinding;
import com.moko.bxp.probe.utils.ToastUtils;

public class PasswordDialog extends MokoBaseDialog<DialogPasswordProbeBinding> {
    ...
    @Override
    protected DialogPasswordProbeBinding getViewBind(LayoutInflater inflater, ViewGroup container) {
        return DialogPasswordProbeBinding.inflate(inflater, container, false);
    }

...
import com.moko.bxp.probe.databinding.DialogChangePasswordProbeBinding;

public class ModifyPasswordDialog extends MokoBaseDialog<DialogChangePasswordProbeBinding> {
    ...
    @Override
    protected DialogChangePasswordProbeBinding getViewBind(LayoutInflater inflater, ViewGroup container) {
        return DialogChangePasswordProbeBinding.inflate(inflater, container, false);
    }
